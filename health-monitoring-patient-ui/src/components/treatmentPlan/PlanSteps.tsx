...
import CompleteStepModal from "@src/components/treatmentPlan/CompleteStepModal";
...
const PlanSteps = (props: PlanStepsPatientProps) => {
                ...
                <div className={className}>
                    ...
                    {step.comment && (
                        <div className={styles.StepComment}>
                            <span className={styles.StepCommentTitle}>Коментар:</span>
